...
function menuStatusOnClick() {
	executaAjaxGet('/status', 'page-wrapper', '', previnePadrao());
}

function menuTipoDocumentoOnClick() {
	executaAjaxGet('/tipoDocumento', 'page-wrapper', '', previnePadrao());
}
...
function menuConsultaProcessoPorNomeOnClick() {
	executaAjaxGet('/processoCPOCPPPorNomeInteressado', 'page-wrapper', '',
			previnePadrao());
}

function menuConsultaProcessoPorReOnClick() {
	executaAjaxGet('/processoCPOCPPPorReInteressado', 'page-wrapper', '',
			previnePadrao());
}

function menuAssuntoOnClick() {
	executaAjaxGet('/assunto', 'page-wrapper', '', previnePadrao());
}
