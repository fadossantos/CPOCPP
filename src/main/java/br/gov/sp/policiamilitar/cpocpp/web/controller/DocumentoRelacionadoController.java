...
public class DocumentoRelacionadoController {
    ...
    public void downloadDocumentoRelacionado(@PathVariable Long id, HttpServletResponse response) {
    	...
    	{    	
         ...
         response.setHeader("Content-Disposition", String.format("attachment; filename=\"" + docRel.getNomeDocumentoRelacionado() + ".pdf" + "\""));

         /* "Content-Disposition : attachment" will be directly download, may provide save as popup, based on your browser setting*/
         //response.setHeader("Content-Disposition", String.format("attachment; filename=\"%s\"", file.getName()));
          
         response.setContentLength(docRel.getArrayBytes().length);
  
         InputStream inputStream = new ByteArrayInputStream(docRel.getArrayBytes());
